...
// ✨ Botão do Google com o ícone branco e estilo idêntico ao da imagem fornecida
  ...
  return (
    <button 
      ...
      style={{
        ...
        border: '1px solid #333333',              // Borda fina e escura idêntica à foto
    ...
    >
      {/* Ícone do Google em formato SVG Monocromático Branco */}
      <svg 
        width="18" 
        height="18" 
        viewBox="0 0 24 24" 
